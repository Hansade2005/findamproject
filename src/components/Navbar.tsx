...
import { Menu, X, FolderOpen, LogOut, User, PlusCircle, Search } from 'lucide-react';
          ...
          {currentUser ? (
            ...
            <>
              ...
              <Link
                to="/signup"
                onClick={() => setMenuOpen(false)}
                className="block bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-center font-medium"
              >
                Sign Up
              </Link>
            </>
